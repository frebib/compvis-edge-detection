...
This testing suite consisted of applying the following cumulation of noise-reduction filters to \enquote{9343 AM}, the noisiest of the 3 samples:
...
Each edge detector was applied in turn with every low-pass filtered image to produce the results in~\ref{fig:filtergraph}
